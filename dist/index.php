				    ...
				    <section id="tabs-content">
				        ...
				        <section id="states-content" class="content-wrapper">
				        	...
				        	<div id="states" class="items">
				        		<div class="item"><svg class="arrow" width="54" height="28" viewBox="0 0 54 28" xmlns="http://www.w3.org/2000/svg"><path d="M27 28L1 1h52z" fill="#5E5E5E" fill-rule="evenodd"/></svg>Arizona</div>
				        		<div class="item"><svg class="arrow" width="54" height="28" viewBox="0 0 54 28" xmlns="http://www.w3.org/2000/svg"><path d="M27 28L1 1h52z" fill="#5E5E5E" fill-rule="evenodd"/></svg>Delaware</div>
				        		<div class="item">
